...
ROOT_URLCONF = 'marketbridge.urls'
...
WSGI_APPLICATION = 'marketbridge.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'rise_quack_gown_751974',
        'USER': 'neondb_owner',
        'PASSWORD': 'npg_AHCbuM0Dth8k',
        'HOST': 'ep-dawn-bonus-agc3gcsw.c-2.eu-central-1.aws.neon.tech',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
        },
